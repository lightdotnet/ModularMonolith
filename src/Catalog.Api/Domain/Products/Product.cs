...
/// <see cref="RemoveImage"/>, <see cref="Activate"/>/<see cref="Deactivate"/> — rather than open
/// setters. <see cref="Price"/> and <see cref="VatRate"/> are mapped as EF owned types (table-split,
/// same row): <see cref="Reprice"/>/<see cref="UpdateVatRate"/> mutate the existing tracked instance
/// in place via <see cref="Money.Update"/>/<see cref="VatPercentage.Update"/> rather than reassigning
/// — mirrors
