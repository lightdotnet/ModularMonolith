...
/// <c>Approval.Tests.TestSupport.RecordingPublisher</c>. Shared by <see cref="OrdersTestHost"/>
/// (dispatches the aggregate's queued domain events on <c>SaveChangesAsync</c>) and
/// <c>PlaceOrderCommandHandler</c> (publishes the cross-module <c>OrderPlacedIntegrationEvent</c>
/// directly) — both resolve the same singleton instance.
/// </summary>
