...
{
    [Fact]
    public async Task Handle_ShouldActivateProduct_WhenFound()
    {
        // Arrange
        ...
        // Act
        var result = await handler.Handle(new ActivateProductCommand(product.Id), TestContext.Current.CancellationToken);
